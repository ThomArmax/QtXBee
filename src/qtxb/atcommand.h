 ...
 * @brief The ATCommandType enum defines the AT commands codes
 *
 ...
 * Default : 0
 *
 * @var ATCommand::Command_OP = 0x4F50,
 * @var ATCommand::Command_NH = 0x4E48,
 * @var ATCommand::Command_BH = 0x4248,
 * @var ATCommand::Command_OI = 0x4F49,
 * @var ATCommand::Command_NT = 0x4E54,
 * @var ATCommand::Command_NO = 0x4E4F,
 * @var ATCommand::Command_SC = 0x5343,
 * @var ATCommand::Command_SD = 0x5344,
 * @var ATCommand::Command_ZS = 0x5A53,
 * @var ATCommand::Command_NJ = 0x4E4A,
 * @var ATCommand::Command_JV = 0x4A56,
 * @var ATCommand::Command_NW = 0x4E57,
 * @var ATCommand::Command_JN = 0x4A4E,
 * @var ATCommand::Command_AR = 0x4152,
 * // Security
 * @var ATCommand::Command_EE = 0x4545,
 * @var ATCommand::Command_EO = 0x454F,
 * @var ATCommand::Command_NK = 0x4E4B,
 * @var ATCommand::Command_KY = 0x4B59,
 * // RF Interfacing
 * @var ATCommand::Command_PL = 0x504C,
 * @var ATCommand::Command_PM = 0x504D,
 * @var ATCommand::Command_DB = 0x4442,
 * @var ATCommand::Command_PP = 0x5050,
 * // Serial Interfacing (I/O)
 * @var ATCommand::Command_AP = 0x4150,
 * @var ATCommand::Command_AO = 0x414F,
 * @var ATCommand::Command_BD = 0x4244,
 * @var ATCommand::Command_NB = 0x4E42,
 * @var ATCommand::Command_SB = 0x5342,
 * @var ATCommand::Command_RO = 0x524F,
 * @var ATCommand::Command_D7 = 0x4437,
 * @var ATCommand::Command_D6 = 0x4436,
 * // I/O @var ATCommand::Command_s
 * @var ATCommand::Command_IR = 0x4952,
 * @var ATCommand::Command_IC = 0x4943,
 * @var ATCommand::Command_P0 = 0x5030,
 * @var ATCommand::Command_P1 = 0x5031,
 * @var ATCommand::Command_P2 = 0x5032,
 * @var ATCommand::Command_P3 = 0x5033,
 * @var ATCommand::Command_D0 = 0x4430,
 * @var ATCommand::Command_D1 = 0x4431,
 * @var ATCommand::Command_D2 = 0x4432,
 * @var ATCommand::Command_D3 = 0x4433,
 * @var ATCommand::Command_D4 = 0x4434,
 * @var ATCommand::Command_D5 = 0x4435,
 * @var ATCommand::Command_D8 = 0x4438,
 * @var ATCommand::Command_LT = 0x4C54,
 * @var ATCommand::Command_PR = 0x5052,
 * @var ATCommand::Command_RP = 0x5250,
 * @var ATCommand::Command_V  = 0x2556,
 * @var ATCommand::Command_VP = 0x562B,
 * @var ATCommand::Command_TP = 0x5450,
 * @var ATCommand::Command_VR = 0x5652,
 * @var ATCommand::Command_HV = 0x4856,
 * @var ATCommand::Command_AI = 0x4149,
 * // AT @var ATCommand::Command_ Options
 * @var ATCommand::Command_CT = 0x4354,
 * @var ATCommand::Command_CN = 0x434E,
 * @var ATCommand::Command_GT = 0x4754,
 * @var ATCommand::Command_CC = 0x4343,
 * // Sleep @var ATCommand::Command_s
 * @var ATCommand::Command_SM = 0x534D,
 * @var ATCommand::Command_SN = 0x534E,
 * @var ATCommand::Command_SP = 0x5350,
 * @var ATCommand::Command_ST = 0x5354,
 * @var ATCommand::Command_SO = 0x534F,
 * @var ATCommand::Command_WH = 0x5748,
 * @var ATCommand::Command_SI = 0x5349,
 * @var ATCommand::Command_PO = 0x504F,
 * // Execution @var ATCommand::Command_s
 * @var ATCommand::Command_AC = 0x4143,
 * @var ATCommand::Command_WR = 0x5752,
 * @var ATCommand::Command_RE = 0x5245,
 * @var ATCommand::Command_FR = 0x4652,
 * @var ATCommand::Command_NR = 0x4E52,
 * @var ATCommand::Command_CB = 0x4342,
 * @var ATCommand::Command_ND = 0x4E44,
 * @var ATCommand::Command_DN = 0x444E,
 * @var ATCommand::Command_IS = 0x4953,
 * @var ATCommand::Command_1S = 0x3153
 */
